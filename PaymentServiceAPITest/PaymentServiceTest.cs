...
namespace PaymentServiceAPITest
{
    public class PaymentServiceTest
    {
        ...
        public async Task PaymentService_Should_Retrun_Success_And_use_the_CheapPaymentGateway()
        {
            ...
            Construct(CheapModelHelper.CheapGatewayReturnTrue(), CheapModelHelper.CheapPaymentModel(), CheapModelHelper.ReturnCheapPaymentDTO());
            var expected = "Transaction Successful";
        ...
        public async Task PaymentService_Should_Retrun_Success_And_use_the_ExpensivePaymentGateway()
        {
            //Arrange
            var paymentService = new PaymentServiceExecutor(serviceProvider);
            Construct(ExpensiveModelHelper.ExpensiveGatewayResultTrue(), ExpensiveModelHelper.ExpensivePaymentModel(), ExpensiveModelHelper.ReturnExpensivePaymentDTO());
            var expected = "Transaction Successful";
        ...
        public async Task PaymentService_Should_Retrun_Success_And_use_the_PremiumPaymentGateway()
        {
            //Arrange
            var paymentService = new PaymentServiceExecutor(serviceProvider);
            Construct(PremiumModelHelper.PremiumGatewayResultTrue(), PremiumModelHelper.PremiumPaymentModel(), PremiumModelHelper.ReturnPremiumPaymentDTO());
            var expected = "Transaction Successful";
